...
i=0
with open('/Users/vasiliskyrillidis/Desktop/raffle bot slamdunk/csv form.csv') as file_obj:
...
while(j<i):
    ...
    browser.get('https://www.buzzsneakers.gr/')
    wait = WebDriverWait(browser, 5)
    browser.maximize_window()
    
    browser.find_element_by_id('/html/body/div[1]/div/div[1]/div/div[3]/div/nav[1]/ul/li[2]/a')
    ...
    city=browser.find_element(By.XPATH,"//*[@name='city']").send_keys("ΑΤΤΙΚΗ")
